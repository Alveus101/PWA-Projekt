...
<head>
    ...
    <title>No Permission | Welt</title>
</head>
<body class="main">
    <?php 
    ...
    <section id="message">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="error">Tvoj korisnički račun nema dozvolu za pristup ovoj stranici!<br>Ukoliko misliš da je ovo greška probaj se ponovo ulogirati ili kontaktiraj administratora.</div>
                </div>
            </div>
        </div>
    </section>
